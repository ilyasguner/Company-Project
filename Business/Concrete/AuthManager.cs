...
{
    public class AuthManager//Data Access Layer yani veri işleme bölümü ile kullanıcı arayüzü arasındaki bağlantıyı sağlayan kısım
    {
        ...
        string IsAuthComplete(Auth auth)
        {
            ...
            {
                return "Lütfen En Fazla 20 Karakterlik Yetki Bilgisi Giriniz";
            }
            return "";
        }
